...
class EpartenairesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        sitemap_url = 'https://boutiquedesartsmartiaux.com/sitemap_products_2.xml?from=7958964764891&to=14946125021557'
    ...
    def parse_product(self, response):
        ...
        # Extraction des images avec filtrage
        image = response.xpath(
            ...
            '//div[contains(@class, "product-image-container")]//img/@src | '
